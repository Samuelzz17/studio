...
export default function AssetPurchasesPage() {
  ...
  const handleSaveAsset = (values: AssetInvestmentFormData) => {
    ...
    toast({
        title: 'Success!',
        description: `Asset purchase for ${values.name} has been recorded.`,
    });
  ...
  const renderContent = () => {
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm mt-8">
          <div className="flex flex-col items-center gap-1 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              You need to select an outlet to see the asset purchases.
            </p>
          </div>
        </div>
      );
    ...
    return (
        <Card>
          <CardHeader>
            <CardTitle>Asset Purchase History</CardTitle>
            <CardDescription>A log of all purchased assets like equipment and furniture.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
